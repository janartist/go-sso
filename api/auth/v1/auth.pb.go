...
var file_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x2a, 0x48, 0x0a, 0x0b, 0x45, 0x72,
	...
	0xa0, 0x45, 0xf4, 0x03, 0x32, 0x69, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x61, 0x0a, 0x06,
	0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x12, 0x1a, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x75, 0x74,
	...
	0x2e, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x21, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x1b, 0x3a, 0x0b, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x5f, 0x62, 0x6f, 0x64,
	0x79, 0x22, 0x0c, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x42,
	0x23, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x50, 0x01,
	0x5a, 0x12, 0x73, 0x73, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x76,
...
var file_auth_v1_auth_proto_goTypes = []interface{}{
	...
	(*VerifyRequest)(nil),            // 1: api.auth.v1.VerifyRequest
	(*VerifyReply)(nil),              // 2: api.auth.v1.VerifyReply
	(*VerifyRequest_VerifyBody)(nil), // 3: api.auth.v1.VerifyRequest.VerifyBody
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	3, // 0: api.auth.v1.VerifyRequest.verify_body:type_name -> api.auth.v1.VerifyRequest.VerifyBody
	1, // 1: api.auth.v1.Auth.Verify:input_type -> api.auth.v1.VerifyRequest
	2, // 2: api.auth.v1.Auth.Verify:output_type -> api.auth.v1.VerifyReply
