...
func IsApiNotFound(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_API_NOT_FOUND.String() && e.Code == 404
}

func ErrorApiNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, ErrorReason_API_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
...
func IsNoAccess(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_NO_ACCESS.String() && e.Code == 403
}

func ErrorNoAccess(format string, args ...interface{}) *errors.Error {
	return errors.New(403, ErrorReason_NO_ACCESS.String(), fmt.Sprintf(format, args...))
}
